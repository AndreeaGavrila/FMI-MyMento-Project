        ...
        login.setOnClickListener(v -> {
            ...
            else
            {
                ...
                new Thread(() -> {
                    ...
                    LiveData<List<SpecificCourse>> courses = specificCourseRepository.getAllSpecificCoursesForStudent(student.getIdStudent());
                    System.out.println("courses specific");
                    System.out.println(courses.getValue().toString());
